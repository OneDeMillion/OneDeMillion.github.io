const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5607916&units=imperial&APPID=e2cbb136e5d205d1154dddf8d9c86021";
...
const apiURL2 =
  "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=e2cbb136e5d205d1154dddf8d9c86021";
...
fetch(apiURL2)
  ...
  .then(jsObject => {
    ...
    let fiveDayForecast = jsObject.list.filter(x =>
    ...
    for (let i = 0; i < fiveDayForecast.length; i++) {
      document.getElementById(`forecast${i + 1}`).textContent =
        fiveDayForecast[i].main.temp;
